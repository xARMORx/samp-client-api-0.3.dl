...
static mut D3D9_DEVICE_PTR: *mut *mut IDirect3DDevice9 = 0xC97C28 as *mut *mut _;
static mut D3D9_DEVICE: *mut IDirect3DDevice9 = 0 as *mut _;
static mut RENDER_HOOK_FN: Option<RenderFn> = None;
static mut RESET_HOOK_FN: Option<ResetFn> = None;
static mut THIS_DEVICE: *mut IDirect3DDevice9 = 0 as *mut _;

pub type RenderFn = fn(&mut IDirect3DDevice9);
pub type ResetFn = fn(&mut IDirect3DDevice9, u8);
...
pub fn set_proxy(render: Option<RenderFn>, reset: Option<ResetFn>) -> bool {
    unsafe {
        if (*D3D9_DEVICE_PTR).is_null() {
            return false;
        }

        D3D9_DEVICE = *D3D9_DEVICE_PTR;
        ...
        RESET_HOOK_FN = reset;
        (*D3D9_DEVICE_PTR) = leak(device) as *mut _;
        THIS_DEVICE = *D3D9_DEVICE_PTR;
    }
...
pub fn unset_proxy() {
    unsafe {
        if D3D9_DEVICE.is_null() {
            return; // no installed hooks
        }

        //        let mut vftable = std::ptr::null_mut();
        //
        //        {
        //            let device = Box::from_raw(*D3D9_DEVICE_PTR as *mut Device);
        //            *D3D9_DEVICE_PTR = D3D9_DEVICE;
        //            vftable = device.vftable;
        //        }
        //
...
//     unsafe { &mut **D3D9_DEVICE_PTR }
// }

//pub fn device() -> &'static mut IDirect3DDevice9 {
//    unsafe { &mut *D3D9_DEVICE }
//}

pub fn device() -> &'static mut IDirect3DDevice9 {
    super::device_proxy::device()
}
...
unsafe extern "system" fn Release(this: *mut IUnknown) -> ULONG {
    ...
    println!("RELEASE {}", result - 1);
    crate::utils::error_message_box("wow", format!("release {}", result - 1));

    if result == 1 {
        println!("delete(*mut Device)");
...
unsafe extern "system" fn SetCursorPosition(
    _this: *mut IDirect3DDevice9, X: INT, Y: INT, Flags: DWORD,
) {
...
unsafe extern "system" fn CreateAdditionalSwapChain(
    _this: *mut IDirect3DDevice9, pPresentationParameters: *mut D3DPRESENT_PARAMETERS,
...
unsafe extern "system" fn GetSwapChain(
    _this: *mut IDirect3DDevice9, iSwapChain: UINT, pSwapChain: *mut *mut IDirect3DSwapChain9,
) -> HRESULT {
    ...
    if result == 0 {
        ...
        error_message_box(
            ...
            &format!(
                ...
                result, D3D9_DEVICE, *D3D9_DEVICE_PTR, _this, THIS_DEVICE,
            ),
        );
    }
...
unsafe extern "system" fn Present(
    _this: *mut IDirect3DDevice9, pSourceRect: *const RECT, pDestRect: *const RECT,
...
unsafe extern "system" fn GetBackBuffer(
    _this: *mut IDirect3DDevice9, iSwapChain: UINT, iBackBuffer: UINT, Type: D3DBACKBUFFER_TYPE,
...
unsafe extern "system" fn GetRasterStatus(
    _this: *mut IDirect3DDevice9, iSwapChain: UINT, pRasterStatus: *mut D3DRASTER_STATUS,
) -> HRESULT {
    (*D3D9_DEVICE).GetRasterStatus(iSwapChain, pRasterStatus)
}

unsafe extern "system" fn SetDialogBoxMode(
    _this: *mut IDirect3DDevice9, bEnableDialogs: BOOL,
) -> HRESULT {
    (*D3D9_DEVICE).SetDialogBoxMode(bEnableDialogs)
}

unsafe extern "system" fn SetGammaRamp(
    _this: *mut IDirect3DDevice9, iSwapChain: UINT, Flags: DWORD, pRamp: *const D3DGAMMARAMP,
) {
    (*D3D9_DEVICE).SetGammaRamp(iSwapChain, Flags, pRamp)
}

unsafe extern "system" fn GetGammaRamp(
    _this: *mut IDirect3DDevice9, iSwapChain: UINT, pRamp: *mut D3DGAMMARAMP,
) {
    (*D3D9_DEVICE).GetGammaRamp(iSwapChain, pRamp)
}

unsafe extern "system" fn CreateTexture(
    _this: *mut IDirect3DDevice9, Width: UINT, Height: UINT, Levels: UINT, Usage: DWORD,
...
unsafe extern "system" fn CreateVolumeTexture(
    _this: *mut IDirect3DDevice9, Width: UINT, Height: UINT, Depth: UINT, Levels: UINT,
...
unsafe extern "system" fn CreateCubeTexture(
    _this: *mut IDirect3DDevice9, EdgeLength: UINT, Levels: UINT, Usage: DWORD, Format: D3DFORMAT,
    Pool: D3DPOOL, ppCubeTexture: *mut *mut IDirect3DCubeTexture9, pSharedHandle: *mut HANDLE,
) -> HRESULT {
...
unsafe extern "system" fn CreateVertexBuffer(
    _this: *mut IDirect3DDevice9, Length: UINT, Usage: DWORD, FVF: DWORD, Pool: D3DPOOL,
...
unsafe extern "system" fn CreateIndexBuffer(
    _this: *mut IDirect3DDevice9, Length: UINT, Usage: DWORD, Format: D3DFORMAT, Pool: D3DPOOL,
...
unsafe extern "system" fn CreateRenderTarget(
    _this: *mut IDirect3DDevice9, Width: UINT, Height: UINT, Format: D3DFORMAT,
...
unsafe extern "system" fn UpdateSurface(
    _this: *mut IDirect3DDevice9, pSourceSurface: *mut IDirect3DSurface9, pSourceRect: *const RECT,
...
unsafe extern "system" fn UpdateTexture(
    _this: *mut IDirect3DDevice9, pSourceTexture: *mut IDirect3DBaseTexture9,
...
unsafe extern "system" fn GetRenderTargetData(
    _this: *mut IDirect3DDevice9, pRenderTarget: *mut IDirect3DSurface9,
...
unsafe extern "system" fn GetFrontBufferData(
    _this: *mut IDirect3DDevice9, iSwapChain: UINT, pDestSurface: *mut IDirect3DSurface9,
) -> HRESULT {
...
unsafe extern "system" fn StretchRect(
    _this: *mut IDirect3DDevice9, pSourceSurface: *mut IDirect3DSurface9, pSourceRect: *const RECT,
    pDestSurface: *mut IDirect3DSurface9, pDestRect: *const RECT, Filter: D3DTEXTUREFILTERTYPE,
) -> HRESULT {
    (*D3D9_DEVICE).StretchRect(pSourceSurface, pSourceRect, pDestSurface, pDestRect, Filter)
}

unsafe extern "system" fn ColorFill(
    _this: *mut IDirect3DDevice9, pSurface: *mut IDirect3DSurface9, pRect: *const RECT,
    color: D3DCOLOR,
) -> HRESULT {
...
unsafe extern "system" fn CreateOffscreenPlainSurface(
    _this: *mut IDirect3DDevice9, Width: UINT, Height: UINT, Format: D3DFORMAT, Pool: D3DPOOL,
    ppSurface: *mut *mut IDirect3DSurface9, pSharedHandle: *mut HANDLE,
) -> HRESULT {
...
unsafe extern "system" fn SetRenderTarget(
    _this: *mut IDirect3DDevice9, RenderTargetIndex: DWORD, pRenderTarget: *mut IDirect3DSurface9,
) -> HRESULT {
    (*D3D9_DEVICE).SetRenderTarget(RenderTargetIndex, pRenderTarget)
}

unsafe extern "system" fn GetRenderTarget(
    _this: *mut IDirect3DDevice9, RenderTargetIndex: DWORD,
...
unsafe extern "system" fn SetDepthStencilSurface(
    _this: *mut IDirect3DDevice9, pNewZStencil: *mut IDirect3DSurface9,
) -> HRESULT {
    (*D3D9_DEVICE).SetDepthStencilSurface(pNewZStencil)
}

unsafe extern "system" fn GetDepthStencilSurface(
    _this: *mut IDirect3DDevice9, ppZStencilSurface: *mut *mut IDirect3DSurface9,
) -> HRESULT {
...
unsafe extern "system" fn Clear(
    _this: *mut IDirect3DDevice9, Count: DWORD, pRects: *const D3DRECT, Flags: DWORD,
...
unsafe extern "system" fn DrawPrimitive(
    _this: *mut IDirect3DDevice9, PrimitiveType: D3DPRIMITIVETYPE, StartVertex: UINT,
    PrimitiveCount: UINT,
) -> HRESULT {
...
unsafe extern "system" fn DrawIndexedPrimitive(
    _this: *mut IDirect3DDevice9, arg1: D3DPRIMITIVETYPE, BaseVertexIndex: INT,
...
unsafe extern "system" fn DrawPrimitiveUP(
    _this: *mut IDirect3DDevice9, PrimitiveType: D3DPRIMITIVETYPE, PrimitiveCount: UINT,
...
unsafe extern "system" fn DrawIndexedPrimitiveUP(
    _this: *mut IDirect3DDevice9, PrimitiveType: D3DPRIMITIVETYPE, MinVertexIndex: UINT,
    NumVertices: UINT, PrimitiveCount: UINT, pIndexData: *const VOID, IndexDataFormat: D3DFORMAT,
    pVertexStreamZeroData: *const VOID, VertexStreamZeroStride: UINT,
) -> HRESULT {
...
unsafe extern "system" fn ProcessVertices(
    _this: *mut IDirect3DDevice9, SrcStartIndex: UINT, DestIndex: UINT, VertexCount: UINT,
...
unsafe extern "system" fn CreateVertexDeclaration(
    _this: *mut IDirect3DDevice9, pVertexElements: *const D3DVERTEXELEMENT9,
...
unsafe extern "system" fn SetVertexDeclaration(
    _this: *mut IDirect3DDevice9, pDecl: *mut IDirect3DVertexDeclaration9,
) -> HRESULT {
    (*D3D9_DEVICE).SetVertexDeclaration(pDecl)
}

unsafe extern "system" fn GetVertexDeclaration(
    _this: *mut IDirect3DDevice9, ppDecl: *mut *mut IDirect3DVertexDeclaration9,
) -> HRESULT {
...
unsafe extern "system" fn CreateVertexShader(
    _this: *mut IDirect3DDevice9, pFunction: *const DWORD,
...
unsafe extern "system" fn SetVertexShader(
    _this: *mut IDirect3DDevice9, pShader: *mut IDirect3DVertexShader9,
) -> HRESULT {
    (*D3D9_DEVICE).SetVertexShader(pShader)
}

unsafe extern "system" fn GetVertexShader(
    _this: *mut IDirect3DDevice9, ppShader: *mut *mut IDirect3DVertexShader9,
) -> HRESULT {
    (*D3D9_DEVICE).GetVertexShader(ppShader)
}

unsafe extern "system" fn SetVertexShaderConstantF(
    _this: *mut IDirect3DDevice9, StartRegister: UINT, pConstantData: *const FLOAT,
    Vector4fCount: UINT,
) -> HRESULT {
...
unsafe extern "system" fn GetVertexShaderConstantF(
    _this: *mut IDirect3DDevice9, StartRegister: UINT, pConstantData: *mut FLOAT,
    Vector4fCount: UINT,
) -> HRESULT {
...
unsafe extern "system" fn SetVertexShaderConstantI(
    _this: *mut IDirect3DDevice9, StartRegister: UINT, pConstantData: *const INT,
    Vector4iCount: UINT,
) -> HRESULT {
...
unsafe extern "system" fn GetVertexShaderConstantI(
    _this: *mut IDirect3DDevice9, StartRegister: UINT, pConstantData: *mut INT, Vector4iCount: UINT,
) -> HRESULT {
...
unsafe extern "system" fn SetVertexShaderConstantB(
    _this: *mut IDirect3DDevice9, StartRegister: UINT, pConstantData: *const BOOL, BoolCount: UINT,
) -> HRESULT {
...
unsafe extern "system" fn GetVertexShaderConstantB(
    _this: *mut IDirect3DDevice9, StartRegister: UINT, pConstantData: *mut BOOL, BoolCount: UINT,
) -> HRESULT {
    (*D3D9_DEVICE).GetVertexShaderConstantB(StartRegister, pConstantData, BoolCount)
}

unsafe extern "system" fn SetStreamSource(
    _this: *mut IDirect3DDevice9, StreamNumber: UINT, pStreamData: *mut IDirect3DVertexBuffer9,
...
unsafe extern "system" fn GetStreamSource(
    _this: *mut IDirect3DDevice9, StreamNumber: UINT,
    ppStreamData: *mut *mut IDirect3DVertexBuffer9, pOffsetInBytes: *mut UINT, pStride: *mut UINT,
) -> HRESULT {
    (*D3D9_DEVICE).GetStreamSource(StreamNumber, ppStreamData, pOffsetInBytes, pStride)
}

unsafe extern "system" fn SetStreamSourceFreq(
    _this: *mut IDirect3DDevice9, StreamNumber: UINT, Setting: UINT,
) -> HRESULT {
    (*D3D9_DEVICE).SetStreamSourceFreq(StreamNumber, Setting)
}

unsafe extern "system" fn GetStreamSourceFreq(
    _this: *mut IDirect3DDevice9, StreamNumber: UINT, pSetting: *mut UINT,
) -> HRESULT {
    (*D3D9_DEVICE).GetStreamSourceFreq(StreamNumber, pSetting)
}

unsafe extern "system" fn SetIndices(
    _this: *mut IDirect3DDevice9, pIndexData: *mut IDirect3DIndexBuffer9,
) -> HRESULT {
    (*D3D9_DEVICE).SetIndices(pIndexData)
}

unsafe extern "system" fn GetIndices(
    _this: *mut IDirect3DDevice9, ppIndexData: *mut *mut IDirect3DIndexBuffer9,
) -> HRESULT {
...
unsafe extern "system" fn SetPixelShader(
    _this: *mut IDirect3DDevice9, pShader: *mut IDirect3DPixelShader9,
) -> HRESULT {
    (*D3D9_DEVICE).SetPixelShader(pShader)
}

unsafe extern "system" fn GetPixelShader(
    _this: *mut IDirect3DDevice9, ppShader: *mut *mut IDirect3DPixelShader9,
) -> HRESULT {
...
unsafe extern "system" fn DrawRectPatch(
    _this: *mut IDirect3DDevice9, Handle: UINT, pNumSegs: *const FLOAT,
...
unsafe extern "system" fn CreateQuery(
    _this: *mut IDirect3DDevice9, Type: D3DQUERYTYPE, ppQuery: *mut *mut IDirect3DQuery9,
) -> HRESULT {
